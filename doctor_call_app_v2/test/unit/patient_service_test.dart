  ...
  group('PatientService Tests', () {
    ...
    group('getPatients', () {
      ...
      test('should filter patients by priority', () async {
        ...
        // Act
        final result = await patientService.getPatientsByPriority(
          token,
          priority,
        );
    ...
    group('getPatientById', () {
      test('should return patient details', () async {
        ...
        final mockResponse = {'success': true, 'data': mockPatient.toJson()};
    ...
    group('updatePatient', () {
      test('should update patient information', () async {
        ...
        expect(
          result['data']['assigned_doctor_id'],
          updateData['assigned_doctor_id'],
        );
      });
    });
    ...
    group('assignPatient', () {
      test('should assign patient to doctor', () async {
        ...
        // Act
        final result = await patientService.assignPatient(
          token,
          patientId,
          doctorId,
        );
      ...
      test('should handle patient already assigned', () async {
        ...
        when(
          ...
          (_) async => http.Response(json.encode(mockResponse), 409),
        );
    ...
    group('completePatient', () {
      test('should complete patient treatment', () async {
        ...
        // Act
        final result = await patientService.completePatient(
          token,
          patientId,
          completionData,
        );
